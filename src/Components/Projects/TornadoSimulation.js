...
const TornadoSimulation = (props) => (
	<>
		...
		<Typography variant = "body1" gutterBottom component = "div" align = "left" style = {{margin: "10px"}}>
			Using three vector-valued datasets of a tornado, sand dune, and a motorbike rider, I used <b>Paraview</b>
			to create an animation that shows the motorbike rider and the sand dune he is riding on get sucked away by
			the tornado.
			<br /><br />
		...
		<br />
		<div>
			<img src = "TornadoSimulation.jpg" alt = "Reference Images" width = "75%" />
			<Typography variant = "captionText" gutterBottom component = "div" align = "left" style = {{margin: "10px"}}>
